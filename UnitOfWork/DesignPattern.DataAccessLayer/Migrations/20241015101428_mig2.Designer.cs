            ...
            modelBuilder.Entity("DesignPattern.EntityLayer.Concrete.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CustomerId = 1,
                            CustomerBalance = 28000m,
                            CustomerName = "Ali Çınar"
                        },
                        new
                        {
                            CustomerId = 2,
                            CustomerBalance = 32000m,
                            CustomerName = "Zeynep Pınar"
                        },
                        new
                        {
                            CustomerId = 3,
                            CustomerBalance = 38000m,
                            CustomerName = "Mete Öztürk"
                        });
                });
